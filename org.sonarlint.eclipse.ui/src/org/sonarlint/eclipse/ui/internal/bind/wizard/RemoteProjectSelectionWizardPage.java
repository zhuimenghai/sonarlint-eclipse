...
public class RemoteProjectSelectionWizardPage extends AbstractProjectBindingWizardPage {
  ...
  protected void doCreateControl(Composite container) {
    ...
    projectTextBinding = dbc.bindValue(
      ...
      BeanProperties.value(ProjectBindingModel.class, ProjectBindingModel.PROPERTY_REMOTE_PROJECT)
        .observe(model),
      new UpdateValueStrategy().setBeforeSetValidator(new MandatoryStringValidator("You must select a project")),
      null);
